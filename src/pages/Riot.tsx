    ...
    <>
      ...
      >
        ...
        <ArticleSection>
          ...
          <ArticleSubsection title="Working With Me">
            <Highlight
              icon={GroupLarge}
              ...
              content={
                <>
                  <Typography variant="body2">
                    <i>
                      Vicky has been doing excellently during her internship so
                      far, shifting between two projects with vastly different
                      audiences. Her ability to navigate the campaign manager
                      project which is much more complex but also tailored
                      towards internal customers, then pivot to a player-facing
                      project with purchase history has shown that she is very
                      flexible and able to work on multiple types of projects.
                    </i>
                  </Typography>
                  <Typography variant="body2">
                    <br />
                    <i>
                      Her attitude is also always positive and approaches each
                      problem thoughtfully and with curiosity to learn, and at
                      an astonishing speed. She has an eye for innovation and
                      creativity and takes feedback very well, which shows
                      through her rapid design iterations and willingness to
                      share early and often for feedback constantly throughout
                      her projects.
                    </i>
                  </Typography>
                </>
              ...
              content={
                <>
                  ...
                  <Typography variant="body2">
                    <br />
                    <i>
                      She was doing a great job of balancing trying to use
                      design patterns and systems in a re-usable way, while also
                      still striving to make sure user flows were as
                      frictionless as possible. Great eye for detail and was
                      catching potential flow problems way in advance. Also just
                      really fearless for someone so early in their career when
                      it came to presenting her ideas to larger groups.
                    </i>
                  </Typography>
                </>
              }
